...
**Note**: It is not recommended to run your parallelized jobs with Slurm under `~/ucph/hdir` as you might experience issues with Slurm correctly forwarding Kerberos tickets for the SMB protocol. Instead, run your jobs from `/projects/biostat01/people/abc1234` where `abc1234` is your KU user id.
